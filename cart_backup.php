                ...
                if($row['Ma_SP'] == $Ma_SP){?>
                    <tr class="cart_row">
                        ...
                        while($row_size = $result_size->fetch_assoc()){ 
                            foreach($size as $Ma_Size){
                                if($row_size['Ma_Size'] == $Ma_Size){
                                    $sql_price = "SELECT * FROM chitietsanpham WHERE Ma_SP='$row[Ma_SP]' AND Ma_Size='$row_size[Ma_Size]' ";
